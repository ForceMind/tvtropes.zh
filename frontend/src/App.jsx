...
export default function App() {
  ...
  const runColumns = [
    ...
    {
      title: '发现/保存',
      render: (_, record) => `${record.items_found} / ${record.items_saved}`
    },
    {
      title: '开始时间',
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Sider width={220} className="app-sider">
        <div className="brand">TVTropes Zh</div>
        <Menu
          mode="inline"
          ...
          <Space>
            <div>
              ...
              <InputNumber
                ...
                onChange={(value) =>
                  setNewJob((prev) => ({ ...prev, interval_minutes: Number(value || 360) }))
                }
              />
            </div>
            <div>
              ...
              <InputNumber
                ...
                onChange={(value) =>
                  setNewJob((prev) => ({ ...prev, max_pages_per_run: Number(value || 20) }))
                }
              />
            </div>
          </Space>
